...
import { removeAllArticles } from '../reducers/hiddenArticles';
	...
	return (
		<header className={styles.header}>
			<div className={styles.logoContainer}>
				...
				{userSection}
				<FontAwesomeIcon onClick={() => {showAllArticles()}} className={styles.faeye} style={{paddingRight :'10px'}} icon={faEye} />
				</div>
